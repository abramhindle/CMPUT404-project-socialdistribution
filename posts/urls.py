...
from .views import UserView,FriendListView,AreFriendsView, FriendRequestView, PostView, PostViewID, CommentViewList
...
urlpatterns = [
    ...
    path('friendrequest/', FriendRequestView.as_view(), name='friendreq'),
