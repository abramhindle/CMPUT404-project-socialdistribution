...
@followers_bp.route('/authors/<string:author_id>/followers', methods=['GET'])
def followers(author_id: str):
    """get a list of authors who are AUTHOR_ID’s followers"""
    pass


@followers_bp.route('/authors/<string:author_id>/followers/{foreign_author_id}', methods=['DELETE'])
def remove_follower(author_id: str):
    """remove FOREIGN_AUTHOR_ID as a follower of AUTHOR_ID"""
    pass


@followers_bp.route('/authors/<string:author_id>/followers/{foreign_author_id}', methods=['PUT'])
def add_follower(author_id: str):
    """Add FOREIGN_AUTHOR_ID as a follower of AUTHOR_ID (must be authenticated)"""
    pass


@followers_bp.route('/authors/<string:author_id>/followers/{foreign_author_id}', methods=['GET'])
