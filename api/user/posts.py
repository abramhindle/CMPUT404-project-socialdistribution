...
@app.route('/authors/<string:author_id>/posts/<string:post_id>/image', methods=["GET"])
...
@app.route('/authors/<string:author_id>/posts/<string:post_id>/comments', methods=["GET"])
...
@app.route('/authors/<string:author_id>/posts/<string:post_id>/comments', methods=["POST"])
...
@app.route('/authors/<string:author_id>/inbox', methods=["POST"])
...
@app.route('/authors/<string:author_id>/posts/<string:post_id>/likes', methods=["GET"])
def get_likes(author_id: str, post_id: str):
    """a list of likes from other authors on AUTHOR_ID’s post POST_ID"""
    pass


@app.route('/authors/<string:author_id>/liked', methods=["GET"])
...
@app.route('/authors/<string:author_id>/inbox', methods=["GET"])
...
@app.route('/authors/<string:author_id>/inbox', methods=["DELETE"])
