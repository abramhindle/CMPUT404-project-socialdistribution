...
urlpatterns = [
    ...
    path('authors/<uuid:authord>/posts/<uuid:post>/comments/<uuid:comment>/likes/', CommentLikesView.as_view(), name='comment-likes'),
    # path('authors/<uuid:author>/liked/', FollowerAPIView.as_view(), name='service-follower'),
