...
class PostModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Post.objects.create(
            ...
            url="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72b8/post/2f91a911-850f-4655-ac29-9115822c72b9",
            title="Test Title",
            source = "https://www.youtube.com/watch?v=YIJI5U0BWr0",
            origin = "https://www.django-rest-framework.org/api-guide/views/",
            description = "Test Post",
    ...
    def test_url(self):
        post = Post.objects.get(id="2f91a911-850f-4655-ac29-9115822c72a9")
        post_url = post.url
        self.assertEqual(post_url, "http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72a9")
...
class CommentModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Post.objects.create(
            id="2f91a911-850f-4655-ac29-9115822c72b9",
            url="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72b9",
            title="Test Title",
            source = "https://www.youtube.com/watch?v=YIJI5U0BWr0",
            origin = "https://www.django-rest-framework.org/api-guide/views/",
            description = "Test Post",
        ...
        Comment.objects.create(
            ...
            url="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72b9/comment/2f91a911-850f-4655-ac29-9115822c72a7",
            post = post,
            author = authors[1],
        ...
        Comment.objects.create(
            ...
            url="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72b9/comment/2f91a911-850f-4655-ac29-9115822c72b7",
            post = post,
            author = authors[1],
    ...
    def test_url(self):
        ...
        self.assertEqual(comment_url, "http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72b9/comment/2f91a911-850f-4655-ac29-9115822c72a7")
    def test_author(self):
        comment = Comment.objects.get(id="2f91a911-850f-4655-ac29-9115822c72a7")
...
class LikeModelTest(TestCase):
    ...
    def test_post_like_summary(self):
    ...
    def test_post_like_author(self):
        post_like = Like.objects.get(object="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72a9")
    ...
    def test_comment_like_summary(self):
    ...
    def test_comment_like_author(self):
        comment_like = Like.objects.get(object="http://127.0.0.1:8000/author/2f91a911-850f-4655-ac29-9115822c72a8/post/2f91a911-850f-4655-ac29-9115822c72a9/comment/2f91a911-850f-4655-ac29-9115822c72a7")
