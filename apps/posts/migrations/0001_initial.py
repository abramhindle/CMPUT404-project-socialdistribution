    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='core.author')),
            ],
            options={
                'ordering': ['-published'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.URLField(editable=False, verbose_name='source')),
                ('origin', models.URLField(editable=False, verbose_name='origin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='core.author')),
                ('comment', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='posts.comment')),
