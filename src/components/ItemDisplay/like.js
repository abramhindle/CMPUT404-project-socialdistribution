  ...
  return (
    <div className="hflex">
      <div className="list-item">
        ...
        <h5 style={{"marginLeft":"0", "color":"white"}}><a href={authorUrl}>{data.data.author.displayName}</a> liked your {type === "post" ? <a href={postUrl}>post</a> : <a href={postUrl}> comment</a>}</h5>
