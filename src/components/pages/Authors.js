      ...
      <React.Fragment>      
                <Row>
                    ...
                    <div>
                      {loading === false && (
                        <React.Fragment>
                          <h1 className='Authors-leftColLink'> My Plurr Authors</h1>
                          {authors.items.map(author => (   
                            <Card className = 'Card my-5'>
                            <Card.Img variant="top" src={author.profileImage}/>
                            <Card.Body>
                              <Card.Title>
                                <a href={`http://localhost:3000/service/author/${(author.url).split('/')[4]}`}>@{author.displayName}</a>
                                <a href={author.github}><FontAwesomeIcon icon={faGithub}/></a>
                              </Card.Title>
                              <Card.Text>
                                  {author.profileImage}
                                  {author.github}
