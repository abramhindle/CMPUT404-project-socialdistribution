    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='toAuthor', to='author.author')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('fromAuthor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fromAuthor', to='author.author')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
