# Generated by Django 3.0.3 on 2020-03-09 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viewable_to', models.ManyToManyField(related_name='viewable_to', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FriendRequest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('author_friends', models.ManyToManyField(related_name='friends_list', to=settings.AUTH_USER_MODEL)),
                ('current_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
