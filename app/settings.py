...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-by*o*-ml(ino$icci&*2z$y!438+1s87i#mk5g!ttom@#igw=s')
...
CORS_ALLOWED_ORIGINS = [
    # 'http://localhost:3000',    # Uncomment for local debugging if necessary
