    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                >
                    <div className={ edit ? [classes.editButton, classes.editButtonSelected].join(' ') : classes.editButton }>
                        {
                            props.editMode
                            ? <svg onClick={onEditButtonClick} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
