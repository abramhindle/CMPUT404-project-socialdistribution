...
import { Container, Row, Col, Button, Image, Alert, Stack, Nav, Form } from "react-bootstrap";
            ...
            <Stack gap={3} style={{marginTop:"7%", marginLeft:"40%"}}>
                ...
                <Form style={{marginLeft:"-13%", width:"50%"}}>
                  <Form.Group className="mb-3" controlId="formBasicUsername">
                    ...
                    <Form.Control type="username" placeholder="This is the original username"/>
                  </Form.Group>
                  ...
                  <Form.Group className="mb-3" controlId="formBasicUsername">
                    ...
                    <Form.Control type="githuburl" placeholder="This is the original Github url"/>
                  </Form.Group>
                </Form>
                ...
                <Stack 
                  ...
                  <LinkContainer 
                    to="/profile" 
                    style={{width:"7%", height:"10%", marginTop:"3%", marginRight:"3%"}}
                  >
                    <Nav.Link>
                      <Button 
