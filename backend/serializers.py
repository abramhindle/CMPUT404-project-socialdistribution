...
class PostSerializer(serializers.ModelSerializer):
	...
	def get_id(self, Post):
		...
		but the API requires the uuid be returned as a url
		"""
		return str(Post.author_host) + "author/" + str(Post.author_id) + "/posts/" + str(Post.id)
	...
	def get_comment_link(self, Post):
		return  str(Post.author_host) + "author/" + str(Post.author_id) + "/posts/" + str(Post.id) + "/comments"
