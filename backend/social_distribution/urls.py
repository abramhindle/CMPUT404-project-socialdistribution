...
urlpatterns = [
    ...
    path('edit-post/<str:profileId>/<str:postId>', login_required(TemplateView.as_view(template_name='editPost.html'), redirect_field_name=None)),
    path('view-post/<str:profileId>/<str:postId>', login_required(TemplateView.as_view(template_name='viewPost.html'), redirect_field_name=None)),
