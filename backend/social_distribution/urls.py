...
urlpatterns = [
    ...
    path('edit-post/<int:authorId>/<int:postId>', login_required(TemplateView.as_view(template_name='editPost.html'), redirect_field_name=None)),
    path('view-post/<int:authorId>/<int:postId>', login_required(TemplateView.as_view(template_name='viewPost.html'), redirect_field_name=None)),
