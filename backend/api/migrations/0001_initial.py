    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('FOLLOWING', 'FOLLOWING'), ('FRIENDS', 'FRIENDS')], default='FOLLOWING', max_length=10)),
        ...
        migrations.AddField(
            model_name='post',
            name='categories',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='categories', to='api.PostCategory'),
        ),
        migrations.AddField(
            model_name='post',
            name='comments',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments_list', to='api.Comment'),
        ),
        migrations.AddField(
            model_name='post',
            name='visibleTo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='visible_author', to=settings.AUTH_USER_MODEL),
        ),
    ]
