    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authorA', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='author_A', to=settings.AUTH_USER_MODEL)),
                ('authorB', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='author_B', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
