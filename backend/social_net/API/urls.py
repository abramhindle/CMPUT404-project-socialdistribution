...
urlpatterns = [
  ...
  path('authors', views.AuthorsView, name='AuthorsView'),     # FIXME: "authors/"
  ...
  path('authors/<slug:author_id>/posts', views.PostsView, name='PostsView'),    # FIXME: "/posts/"
  path('authors/<slug:author_id>/inbox', views.InboxView, name='InboxView'),    # FIXME: "/inbox/"
