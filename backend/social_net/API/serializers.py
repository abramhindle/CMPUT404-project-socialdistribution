...
class PostsSerializer(serializers.ModelSerializer):
    type = serializers.CharField(max_length=100, blank=False, default='post')
    title = serializers.CharField(max_length=100, blank=False, default='')
    id = serializers.CharField(max_length=100, primary_key=True)
    source = serializers.CharField(max_length=100, default="")
    origin = serializers.CharField(max_length=100, blank=False, default='')
    description = serializers.CharField(max_length=500, blank=False, default='')
    contentType = serializers.CharField(max_length=100, blank=False, default='')
    content = serializers.CharField(max_length=500, blank=False, default='')
    author = serializers.CharField(max_length=100, blank=False, default='')
    categories = serializers.ListField(child=serializers.CharField())
    count = serializers.IntegerField(default=1023)
    comments = serializers.CharField(max_length=100, blank=False, default='')
    commentsSrc = serializers.ListField(child=serializers.CharField())
    published = serializers.DateTimeField(auto_now_add=True)
