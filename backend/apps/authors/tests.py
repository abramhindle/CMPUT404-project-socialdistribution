...
class Author_TestCase(TestCase):
    ...
    def test_get_nonexisting_author(self):
        """trying to get a non-existant author should return a 404 code"""
        response = c.get('/authors/-1/')
        self.assertEqual(response.status_code, 404)

    def test_get_all_authors(self):
        """get all authors should return a 200 code"""
        response = c.get('/authors/')
        self.assertEqual(response.status_code, 200)

    def test_post_invalid_author(self):
        """trying to create an invalid author should return a 400 code"""
    ...
    def test_create_author(self):
        """creating a valid author should return a 201 code"""
