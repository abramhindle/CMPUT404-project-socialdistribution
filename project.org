...
** Requirements
   ...
   - [ ] Follow the guidelines in the example-article.json for the
     URLs and services
   - [ ] friends querying via POSTs to ://service/author/{AUTHOR_ID}/friends/
   - [ ] implement author profiles via ://service/author/{AUTHOR_ID}
   - [ ] implement author inbox via ://service/author/{AUTHOR_ID}/inbox
   - [ ] implement author outbox via ://service/author/{AUTHOR_ID}/outbox
   - [ ] Enforce some authentication
     - Consider HTTP Basic Auth
   - [ ] implement a restful API for ://service/posts/{POST_ID}
     ...
     - implement an alias ://service/posts/postid for Winter 2015 term projects.
   - [ ] Allow users to accept or reject friend requests
   - [ ] friend requests can be made by POSTing a friend request object to the inbox to 
     http://service/author{AUTHOR_ID}/friendrequest
