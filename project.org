...
*** Scenario 
   ...
   Then I write a public post, a public service announcement about how
   public service announcements are pretentious performative social media
   and you shouldn't make them. The irony is lost on me. Nonetheless my
   node records my post and makes a URL for it and then proceeds to send
   my public post to the inboxes of everyone who follows me. My node knows
   who follows me and thus can just send the public post to each of those
   inboxes. Perhaps there will be a scaling problem in the future.
...
*** Likes
    ...
    - URL: ://service/authors/{author_id}/post/{post_id}/likes
      - GET a list of likes from other authors on author_id's post post_id
    - URL: ://service/authors/{author_id}/post/{post_id}/comments/{comment_id}/likes
